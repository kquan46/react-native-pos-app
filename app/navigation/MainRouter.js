      ...
      <Router hideNavBar>
        <Scene tabs={false} key="root" animationEnabled={false}>
          ...
          <Scene key="menuTab" tabs={true}  default="tab1" tabBarStyle={styles.tabBar}>
            <Scene key="tab1" title="Noodle/Rice" icon={TabIcon} component={MenuTab1} menuList={this.props.menu} />
            <Scene key="tab2" title="MiniSet" icon={TabIcon} component={MenuTab2} menuList={this.props.menu} />
            <Scene key="tab3" title="Snacks" icon={TabIcon} component={MenuTab3} menuList={this.props.menu} />
            <Scene key="tab4" title="Other" icon={TabIcon} component={MenuTab4} menuList={this.props.menu} />
          </Scene>
        </Scene>
      </Router>
    )
